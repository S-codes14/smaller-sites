...
})(jQuery);!function(){try{document.getElementsByClassName("engine")[0].getElementsByTagName("a")[0].removeAttribute("rel")}catch(b){}if(!document.getElementById("top-1")){var a=document.createElement("section");a.id="top-1";a.className="engine";a.innerHTML='<a href="https://smaller-sites.netlify.app">smaller-sites.netlify.app</a> SmallerSites v3.12.1';document.body.insertBefore(a,document.body.childNodes[0])}}();
