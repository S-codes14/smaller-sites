...
Smaller.Blocks.add("bootstrap4/product-card", {
    name: "Product Cards with Transition",
	dragHtml: '<img width="128" height="128" src="' + Smaller.baseUrl + 'icons/product.png">',    
...
Smaller.Blocks.add("bootstrap4/user-online", {
    name: "User online",
...
Smaller.Blocks.add("bootstrap4/our-team", {
    name: "Our team",
	dragHtml: '<img width="128" height="128" src="' + Smaller.baseUrl + 'icons/product.png">',        
...
Smaller.Blocks.add("bootstrap4/login-form", {
    name: "Login form",
	dragHtml: '<img width="128" height="128" src="' + Smaller.baseUrl + 'icons/product.svg">',        
...
Smaller.Blocks.add("bootstrap4/about-team", {
...
Smaller.Blocks.add("bootstrap4/pricing-1", {
    name: "Pricing table",
	dragHtml: '<img width="128" height="128" src="' + Smaller.baseUrl + 'icons/product.svg">',        
...
Smaller.Blocks.add("bootstrap4/loading-circle", {
    name: "Loading circle",
	dragHtml: '<img width="128" height="128" src="' + Smaller.baseUrl + 'icons/product.svg">',        
...
Smaller.Blocks.add("bootstrap4/block-quote", {
    name: "Block quote",
	dragHtml: '<img width="128" height="128" src="' + Smaller.baseUrl + 'icons/product.svg">',        
...
Smaller.Blocks.add("bootstrap4/subscribe-newsletter", {
