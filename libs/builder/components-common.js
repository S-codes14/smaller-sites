...
Smaller.Components.extend("_base", "_base", {
	...
	key: "linked_styles_check",
		...
		afterInit:function(node, inputElement) {
			var selector = Smaller.StyleManager.getSelectorForElement(node);
...
Smaller.Components.extend("_base", "_base", ComponentBaseTypography);
...
Smaller.Components.extend("_base", "_base", ComponentBaseSize);
...
Smaller.Components.extend("_base", "_base", ComponentBaseMargin);
...
Smaller.Components.extend("_base", "_base", ComponentBasePadding);
