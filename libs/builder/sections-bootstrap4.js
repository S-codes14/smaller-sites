...
Smaller.SectionsGroup['Bootstrap'] =
...
Smaller.Sections.add("bootstrap4/signin-split", {
    name: "Modern Sign In Page with Split Screen Format",
	dragHtml: '<img src="' + Smaller.baseUrl + 'icons/product.png">',    
...
Smaller.Sections.add("bootstrap4/image-gallery", {
    name: "Image gallery",
...
Smaller.Sections.add("bootstrap4/slider-header", {
...
Smaller.Sections.add("bootstrap4/video-header", {
    name: "Video Header",
	dragHtml: '<img src="' + Smaller.baseUrl + 'icons/image.svg">',        
...
Smaller.Sections.add("bootstrap4/about-team", {
...
Smaller.Sections.add("bootstrap4/portfolio-one-column", {
...
Smaller.Sections.add("bootstrap4/portfolio-two-column", {
...
Smaller.Sections.add("bootstrap4/portfolio-three-column", {
...
Smaller.Sections.add("bootstrap4/portfolio-four-column", {
