...
Smaller.Components.extend("_base", "widgets/googlemaps", {
    name: "Google Maps",
    attributes: ["data-component-maps"],
    image: "icons/map.svg",
    dragHtml: '<img src="' + Smaller.baseUrl + 'icons/maps.png">',
...
Smaller.Components.extend("_base", "widgets/video", {
    name: "Video",
    attributes: ["data-component-video"],
    image: "icons/video.svg",
    dragHtml: '<img src="' + Smaller.baseUrl + 'icons/video.svg" width="100" height="100">', //use image for drag and swap with iframe on drop for drag performance
...
Smaller.Components.extend("_base", "widgets/facebookcomments", {
    name: "Facebook Comments",
    attributes: ["data-component-facebookcomments"],
    image: "icons/facebook.svg",
    dragHtml: '<img src="' + Smaller.baseUrl + 'icons/facebook.svg">',
...
Smaller.Components.extend("_base", "widgets/instagram", {
    name: "Instagram",
    attributes: ["data-component-instagram"],
    image: "icons/instagram.svg",
    drophtml: '<img src="' + Smaller.baseUrl + 'icons/instagram.png">',
...
Smaller.Components.extend("_base", "widgets/twitter", {
    name: "Twitter",
    attributes: ["data-component-twitter"],
    image: "icons/twitter.svg",
    dragHtml: '<img src="' + Smaller.baseUrl + 'icons/twitter.svg">',
...
Smaller.Components.extend("_base", "widgets/paypal", {
    name: "Paypal",
...
\
				...
				<input type="hidden" name="item_name" value="SmallerJs">\
...
Smaller.Components.extend("_base", "widgets/facebookpage", {
    name: "Facebook Page Plugin",
    attributes: ["data-component-facebookpage"],
    image: "icons/facebook.svg",
    dropHtml: '<img src="' + Smaller.baseUrl + 'icons/facebook.png">',
...
Smaller.Components.extend("_base", "widgets/chartjs", {
    name: "Chart.js",
    attributes: ["data-component-chartjs"],
    image: "icons/chart.svg",
	dragHtml: '<img src="' + Smaller.baseUrl + 'icons/chart.svg">',
	...
	dragStart: function (node)
	{
		...
		body = Smaller.Builder.frameBody;
