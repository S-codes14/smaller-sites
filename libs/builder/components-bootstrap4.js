...
https://github.com/S-codes14/Smallerjs
*/
...
Smaller.ComponentsGroup['Bootstrap 4'] =
...
//display
Smaller.Components.extend("_base", "_base", {
	 properties: [
     {
        key: "display_header",
        inputtype: SectionInput,
...
Smaller.Components.extend("_base", "html/container", {
...
Smaller.Components.extend("_base", "html/heading", {
...
Smaller.Components.extend("_base", "html/link", {
    nodes: ["a"],
    name: "Link",
...
Smaller.Components.extend("_base", "html/image", {
    nodes: ["img"],
    name: "Image",
    html: '<img src="' +  Smaller.baseUrl + 'icons/image.svg" height="128" width="128">',
    /*
...
Smaller.Components.add("html/hr", {
    image: "icons/hr.svg",
    nodes: ["hr"],
    name: "Horizontal Rule",
    html: "<hr>"
});
Smaller.Components.extend("_base", "html/label", {
    name: "Label",
    nodes: ["label"],
...
Smaller.Components.extend("_base", "html/button", {
...
Smaller.Components.extend("_base", "html/buttongroup", {
    classes: ["btn-group"],
    name: "Button Group",
...
Smaller.Components.extend("_base", "html/buttontoolbar", {
    classes: ["btn-toolbar"],
    name: "Button Toolbar",
...
Smaller.Components.extend("_base","html/alert", {
    classes: ["alert"],
    name: "Alert",
...
Smaller.Components.extend("_base", "html/badge", {
    classes: ["badge"],
...
Smaller.Components.extend("_base", "html/card", {
    classes: ["card"],
...
Smaller.Components.extend("_base", "html/listgroup", {
    name: "List Group",
    image: "icons/list_group.svg",
    classes: ["list-group"],
    html: '<ul class="list-group">\n  <li class="list-group-item">\n    <span class="badge">14</span>\n    Cras justo odio\n  </li>\n  <li class="list-group-item">\n    <span class="badge">2</span>\n    Dapibus ac facilisis in\n  </li>\n  <li class="list-group-item">\n    <span class="badge">1</span>\n    Morbi leo risus\n  </li>\n</ul>'
});
Smaller.Components.extend("_base", "html/listitem", {
    name: "List Item",
    classes: ["list-group-item"],
    html: '<li class="list-group-item"><span class="badge">14</span> Cras justo odio</li>'
});
Smaller.Components.extend("_base", "html/breadcrumbs", {
    classes: ["breadcrumb"],
    name: "Breadcrumbs",
...
Smaller.Components.extend("_base", "html/breadcrumbitem", {
...
Smaller.Components.extend("_base", "html/pagination", {
    classes: ["pagination"],
    name: "Pagination",
...
Smaller.Components.extend("_base", "html/pageitem", {
	classes: ["page-item"],
...
Smaller.Components.extend("_base", "html/progress", {
    classes: ["progress"],
    name: "Progress Bar",
...
Smaller.Components.extend("_base", "html/jumbotron", {
    classes: ["jumbotron"],
...
Smaller.Components.extend("_base", "html/navbar", {
    classes: ["navbar"],
...
Smaller.Components.extend("_base", "html/form", {
    nodes: ["form"],
...
Smaller.Components.extend("_base", "html/textinput", {
    name: "Input",
	nodes: ["input"],
...
Smaller.Components.extend("_base", "html/selectinput", {
	nodes: ["select"],
    name: "Select Input",
		...
		$(node).find('option').each(function() {
			...
			properties.push({
				...
				onChange: function(node, value, input) {
					...
					{
						option.remove();
						Smaller.Components.render("html/selectinput");
						return node;
					}
...
Smaller.Components.extend("_base", "html/textareainput", {
    name: "Text Area",
    image: "icons/text_area.svg",
    html: '<div class="mb-3"><label>Your response:</label><textarea class="form-control"></textarea></div>'
});
Smaller.Components.extend("_base", "html/radiobutton", {
    name: "Radio Button",
...
Smaller.Components.extend("_base", "html/checkbox", {
    name: "Checkbox",
...
Smaller.Components.extend("_base", "html/fileinput", {
    name: "Input group",
...
Smaller.Components.extend("_base", "html/table", {
    nodes: ["table"],
    classes: ["table"],
...
Smaller.Components.extend("_base", "html/tablerow", {
    nodes: ["tr"],
    name: "Table Row",
...
Smaller.Components.extend("_base", "html/tablecell", {
    nodes: ["td"],
    name: "Table Cell",
    html: "<td>Cell</td>"
});
Smaller.Components.extend("_base", "html/tableheadercell", {
    nodes: ["th"],
    name: "Table Header Cell",
    html: "<th>Head</th>"
});
Smaller.Components.extend("_base", "html/tablehead", {
    nodes: ["thead"],
    name: "Table Head",
...
Smaller.Components.extend("_base", "html/tablebody", {
    nodes: ["tbody"],
    name: "Table Body",
    html: "<tbody><tr><td>Cell 1</td><td>Cell 2</td><td>Cell 3</td></tr></tbody>"
});

Smaller.Components.add("html/gridcolumn", {
    name: "Grid Column",
...
Smaller.Components.add("html/gridrow", {
    name: "Grid Row",
    image: "icons/grid_row.svg",
    classes: ["row"],
		...
		$(node).find('[class*="col-"]').each(function() {
			...
			properties.push({
				...
				onChange: function(node, value, input) {
					...
					{
						column.remove();
						Smaller.Components.render("html/gridrow");
						return node;
					}
...
Smaller.Components.extend("_base", "html/paragraph", {
    nodes: ["p"],
    name: "Paragraph",
...
Smaller.Components.extend("_base", "html/video", {
    nodes: ["video"],
    name: "Video",
    ...
    dragHtml: '<img  width="320" height="240" src="' + Smaller.baseUrl + 'icons/video.svg">',
