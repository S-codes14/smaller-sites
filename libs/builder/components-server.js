...
Smaller.ComponentsGroup['Server Components'] = ["components/products", "components/product", "components/categories", "components/manufacturers", "components/search", "components/user", "components/product_gallery", "components/cart", "components/checkout", "components/filters", "components/product", "components/slider"];


Smaller.Components.add("components/product", {
    name: "Product",
...
Smaller.Components.add("components/products", {
    name: "Products",
...
Smaller.Components.add("components/manufacturers", {
    name: "Manufacturers",
...
Smaller.Components.add("components/categories", {
    name: "Categories",
...
Smaller.Components.add("components/search", {
    name: "Search",
...
Smaller.Components.add("components/user", {
    name: "User",
...
Smaller.Components.add("components/product_gallery", {
...
Smaller.Components.add("components/cart", {
    name: "Cart",
...
Smaller.Components.add("components/checkout", {
    name: "Checkout",
...
Smaller.Components.add("components/filters", {
    name: "Filters",
...
Smaller.Components.add("components/slider", {
    name: "Slider",
